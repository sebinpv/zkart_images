...
import { editProduct, getAProductShop } from "../../redux/actions/product";
...
const EditProduct = () => {
  ...
  const [originalPrice, setOriginalPrice] = useState(singleproduct?.originalPrice);
  const [discountPrice, setDiscountPrice] = useState(singleproduct?.discountPrice);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(editProduct(newForm, id));
  };
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <input
            ...
            value={originalPrice}
            className="mt-2 appearance-none block w-full px-3 h-[35px] border border-gray-300 rounded-[3px] placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
            onChange={(e) => setOriginalPrice(e.target.value.Number)}
