      ...
      {isLoading ? (
        ...
        <div className="w-full mx-8 pt-1 mt-10 bg-white">
          <div className="w-full flex justify-end">
            <div
              className={`button !w-max !h-[45px] px-3 !rounded-[5px] mr-3 mb-3`}
                ...
                <form onSubmit={handleSubmit} aria-required={true}>
                  ...
                  <div>
                    <input
                      type="submit"
                      value="Create Coupon"
                      className="button mt-3 ml-[200px] text-center block w-[150px] border sm:text-sm"
                    />
                  </div>
                </form>
              </div>
