...
const DashboardHero = () => {
  ...
  const availableBalance = admin?.wallet;
  ...
  return (
    <div className="w-full p-8">
      ...
      <div className="w-full block 800px:flex items-center justify-between">
        <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white border-2 border-[#febd69] shadow rounded-lg px-2 py-5">
          ...
          <Link className="link" to="">
            <h5 className="w-[315px] mt-3 button text-center !rounded">Withdraw Money</h5>
          </Link>
        </div>
        ...
        <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white border-2 border-[#febd69] shadow rounded-lg px-2 py-5">
          ...
          <Link className="link" to="/dashboard-orders">
            <h5 className="w-[315px] mt-3 button text-center !rounded">View Orders</h5>
          </Link>
        </div>
        ...
        <div className="w-full mb-4 800px:w-[30%] min-h-[20vh] bg-white border-2 border-[#febd69] shadow rounded-lg px-2 py-5">
          ...
          <Link className="link" to="/dashboard-products">
            <h5 className="w-[315px] mt-3 button text-center !rounded">View Products</h5>
          </Link>
        </div>
      </div>
      <br />
