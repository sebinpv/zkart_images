...
import { createBlogCategory } from "../../redux/actions/blogCategory";
...
const CreateBlogCategory = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(createBlogCategory({name: name}));
  };

  return (
    <div className="w-[90%] mt-[50px] 800px:w-[50%] bg-white  shadow h-[60vh] rounded-[4px] p-3 overflow-y-scroll">
      <h5 className="text-[30px] font-Poppins text-center">Create Blog Category</h5>
