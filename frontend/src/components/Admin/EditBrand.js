...
import { editBrand, getABrand } from "../../redux/actions/brand";
...
const EditBrand = () => {
  ...
  const brandState = useSelector((state) => state.brand?.singleBrand);
  ...
  const [name, setName] = useState(brandState?.name);
