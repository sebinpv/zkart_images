...
import { editCategory, getACategory } from "../../redux/actions/category";
...
const EditCategory = () => {
  ...
  const cat = useSelector((state) => state.category?.singleCategory);
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(editCategory(newForm,id));
  };

  return (
    <div className="w-[90%] mt-[50px] 800px:w-[50%] bg-white  shadow h-[90vh] rounded-[4px] p-3 overflow-y-scroll">
      <h5 className="text-[30px] font-Poppins text-center">Edit Category</h5>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
              ...
              <div className="mt-2 mb-4 flex items-center">
                ...
                >
                  <span className="w-[150px]">Upload an image</span>
                  <input
                    type="file"
                    name="avatar"
                    id="file-input"
